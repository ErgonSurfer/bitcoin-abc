...
# Exercise the Ergon ABC RPC calls.
...
class ExcessiveBlockSizeRPCTest(BitcoinTestFramework):
    ...
    def test_excessiveblock(self):
        ...
        self.check_subversion(r"/Ergon ABC:.*\(EB2\.0; .*\)/")
        ...
        # Check for EB correctness in the subver string
        self.check_subversion(r"/Ergon ABC:.*\(EB13\.0; .*\)/")
        ...
        # check for EB correctness in the subver string
        self.check_subversion(r"/Ergon ABC:.*\(EB13\.1; .*\)/")
