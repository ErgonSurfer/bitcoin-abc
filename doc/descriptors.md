# Support for Output Descriptors in Ergon ABC

Since Ergon ABC v0.20.7, there is support for Output Descriptors. This is a
...
existing Ergon ABC wallets, a convenience function `combo` is provided,
...
All RPCs in Ergon ABC will include the checksum in their output. Only
