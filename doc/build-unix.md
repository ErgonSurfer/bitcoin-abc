UNIX BUILD NOTES
====================
Some notes on how to build Ergon ABC in Unix.
...
*Note: Ergon ABC provides a [Docker image with all the dependencies preinstalled](#build-using-a-docker-container).*
...
memory available when compiling Ergon ABC. On systems with less, gcc can be
...
See the section "Disable-wallet mode" to build Ergon ABC without wallet.
...
Security
--------
To help make your Ergon ABC installation more secure by making certain attacks impossible to
...
* _Non-executable Stack_: If the stack is executable then trivial stack-based buffer overflow exploits are possible if
    vulnerable buffers are found. By default, Ergon ABC should be built with a non-executable stack,
