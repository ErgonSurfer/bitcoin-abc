...
The Ergon ABC daemon can be configured to act as a trusted "border
...
The ZeroMQ feature in Ergon ABC requires the ZeroMQ API >= 4.1.5
...
To disable, use -DBUILD_ZMQ=OFF to `cmake` when building bitcoind:
