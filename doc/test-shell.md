...
## 2. Importing `TestShell` from the Ergon ABC repository

We can import the `TestShell` by adding the path of the Ergon ABC
...
| `cachedir` | `"/path/to/test/cache"` | Sets the bitcoind datadir directory. |
