...
This spec is based on the Ergon ABC implementation of the [Bitcoin Cash](https://www.bitcoincash.org/) protocol.

Developer resources:
- [Ergon ABC source code](https://github.com/Bitcoin-ABC/bitcoin-abc)
- [Ergon ABC developer documentation](https://www.bitcoinabc.org/doc/dev/)
