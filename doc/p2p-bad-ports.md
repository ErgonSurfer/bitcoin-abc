When Ergon ABC automatically opens outgoing P2P connections it chooses
...
A malicious actor may gossip an address:port where no Ergon ABC node is
...
and usually require authentication. A connection attempt (by Ergon ABC, trying
...
Below is a list of "bad" ports which Ergon ABC avoids when choosing a peer to
