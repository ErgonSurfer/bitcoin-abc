# Ergon ABC 0.30.3 Release Notes

Ergon ABC version 0.30.3 is now available from:
...
Starting with this release, the Ergon ABC ARM (32 bits) version is deprecated.
It will no longer be delivered with the release binaries. Users that still want
to run Ergon ABC on this platform should build the binary from the sources.
