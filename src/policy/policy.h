 ...
 */
static constexpr Amount DEFAULT_BLOCK_MIN_TX_FEE_PER_KB(10 * SATOSHI);
/**
 ...
 */
static constexpr Amount DUST_RELAY_TX_FEE(10 * SATOSHI);

/** Default for -minrelaytxfee, minimum relay fee for transactions */
static constexpr Amount DEFAULT_MIN_RELAY_TX_FEE_PER_KB(10 * SATOSHI);
